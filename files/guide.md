...
⦁	``PATIENCE``.
⦁	FOLLOW ``ROADMAP``, TAKE CLASSES AND TUTORIALS, READ TEXTBOOKS AND DOCUMENTATION, FOLLOW PROJECTS AND COMPLETE YOUR OWN.
...
⦁	REVIEW, TEST AND ``CHALLENGE YOURSELF``.
⦁   COMPLETE 4-8 HOURS OF ``DEEP WORK``, SPLIT INTO 45 MIN SPRINTS AND 15 MINUTE BREAKS.

## ROADMAP
⦁	GIT.

⦁ HTML, CSS, JAVASCRIPT AND USER INTERFACES.
    CS50X WEEK 8.
    CS50 WEB WEEK [0, 5, 6].
    WEB DESIGN TEXTBOOK.
    REACT TEXTBOOK.
    CODINGLAB TUTORIALS.
    PROJECTS ECHO [SIGNUP, LOGIN, HOME, SEARCH].

⦁ SQL.
    CS50X WEEK 7.
    CS50SQL.
    CS50 WEB WEEEK 4.
    PROJECTS ECHO DATABASE.
...
⦁ FLASK.
    CS50X WEEK9.
    FLASK WEB DEVELOPMENT TEXTBOOK.
...
⦁ PROJECT ECHO AUTHENTICATION, SEARCH AND RECOMMENDATION.
⦁ ECHO.
